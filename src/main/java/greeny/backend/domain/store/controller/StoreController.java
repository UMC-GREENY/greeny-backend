...
import static greeny.backend.response.SuccessMessage.SUCCESS_TO_GET_NEW_OR_BEST_SIMPLE_STORE_INFOS;
...
public class StoreController {
    ...
    @Operation(summary = "Get new or best simple store infos with auth member API", description = "please get new or best simple store infos.")
    @ResponseStatus(OK)
